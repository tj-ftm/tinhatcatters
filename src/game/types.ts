...
export interface ImageConfig {
  playerIdle: { src: string; width: number; height: number; frames: number };
  playerRun: { src: string; width: number; height: number; frames: number };
  playerJump: { src: string; width: number; height: number; frames: number };
