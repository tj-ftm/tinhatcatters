                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="h-80">
                          <ResponsiveContainer width="100%" height="100%">
                            ...
                            >
                              ...
                              <Scatter 
                                name="Plants" 
                                data={generateQualityVsTimeData()} 
                                fill="#8884d8"
                                fillOpacity={0.7}
                              />
                            </ScatterChart>
                    ...
                    <Card className="animate-fade-in">
                      ...
                      <CardContent>
                        <div className="h-80">
                          <ResponsiveContainer width="100%" height="100%">
                            <RadarChart outerRadius={90} data={generateEquipmentComparisonData()}>
                              <PolarGrid />
                              <PolarAngleAxis dataKey="type" />
                              <PolarRadiusAxis angle={30} domain={[0, 5]} />
                              <Tooltip formatter={formatTooltipValue} />
                              <Legend />
                              {Object.keys(generateEquipmentComparisonData()[0] || {})
                                .filter(key => key !== 'type')
                                .map((player, index) => (
                                  <Radar
                                    key={player}
                    ...
                    <Card className="animate-fade-in">
                      ...
                      <CardContent>
                        <div className="h-80">
                          <ResponsiveContainer width="100%" height="100%">
                            <BarChart
                              data={generateEquipmentChartData()}
                              layout="vertical"
                          ...
                          <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                              <Pie
                                ...
                                animationBegin={200}
                              >
                                {generateTopProducersData().map((entry, index) => (
